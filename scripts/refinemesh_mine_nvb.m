function [p1,e1,t1,refined]=refinemesh_mine_nvb(g,p,e,t,u,it,mode)
...
%   new ordering of refined triangles is considered to fit to NVB ordering
%
...
% NEW version of the refinement with 3 edges bisected: --------------------
