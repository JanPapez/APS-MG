function [Iout,refine] = interpolation_matrix1(j, refined)
% function for constructing the interpolation matrix between two
% consecutive levels, with refinement corresponding to refinemesh_mine
% and to piecewise affine functions (p = 1)
%
...
%% lagrange grid on the element refined into 4 regular triangles

coordinates_1 = coordinates_temp*0.5;
coordinates_2 = coordinates_temp*0.5 + repmat([0.5; 0],1,nFEM);
coordinates_3 = coordinates_temp*0.5 + repmat([0; 0.5],1,nFEM);
coordinates_4 = repmat([0.5; 0.5],1,nFEM) - coordinates_temp*0.5;
...
coordinates_1 = coordinates_temp*0.5;
    J_2 = [-1 -.5; 1 0];
coordinates_2 = J_2 * coordinates_temp + repmat([1; 0],1,nFEM);
    J_3 = [-.5 -.5; 1 .5];
coordinates_3 = J_3 * coordinates_temp + repmat([.5; 0],1,nFEM);
...
%% lagrange grid on the element refined into 3 triangles (edges 1+3 refined)
    J_1 = [-.5 -.5; .5 0];
coordinates_1 = J_1 * coordinates_temp + repmat([1; 0],1,nFEM);
    J_2 = [0 .5; -1 -1];
coordinates_2 = J_2 * coordinates_temp + repmat([0; 1],1,nFEM);
    J_3 = [.5 .5; -1 -.5];
coordinates_3 = J_3 * coordinates_temp + repmat([0; 1],1,nFEM);
coordinates_all = [coordinates_1, coordinates_2, coordinates_3];
...
%% lagrange grid on the element refined into 2 triangles (edge 3 refined)
    J_1 = [0 .5; -1 -1];
coordinates_1 = J_1 * coordinates_temp + repmat([0; 1],1,nFEM);
    J_2 = [-1 -.5; 1 0];
coordinates_2 = J_2 * coordinates_temp + repmat([1; 0],1,nFEM);
...
for ie = 1:nelem0
    ie_prev = elem(ie);
    interp = addblocktosparse(meshdata(j).elements([1 3 2],ie),meshdata(j-1).elements([1 3 2],ie_prev),eye(nFEM),interp);
end
refine(elem,1) = 0;
...
for ie = 1:nelem1
    ie_prev = elem(ie);
    temp = [meshdata(j).elements([1 3 2],index+ie); meshdata(j).elements([1 3 2],index+ie+nelem1); meshdata(j).elements([1 3 2],index+ie+2*nelem1); meshdata(j).elements([1 3 2],index+ie+3*nelem1)];
    interp = addblocktosparse(temp, meshdata(j-1).elements([1 3 2],ie_prev),I1_loc,interp);
end
refine(elem,1) = 1;
...
for ie = 1:nelem2
    ie_prev = elem(ie);
    temp = [meshdata(j).elements([1 3 2],index+ie); meshdata(j).elements([1 3 2],index+ie+nelem2); meshdata(j).elements([1 3 2],index+ie+2*nelem2)];
    interp = addblocktosparse(temp,meshdata(j-1).elements([1 3 2],ie_prev),I2_loc,interp);
end
refine(elem,1) = 2;
...
for ie = 1:nelem3
    ie_prev = elem(ie);
    temp = [meshdata(j).elements([1 3 2],index+ie); meshdata(j).elements([1 3 2],index+ie+nelem3); meshdata(j).elements([1 3 2],index+ie+2*nelem3)];
    interp = addblocktosparse(temp,meshdata(j-1).elements([1 3 2],ie_prev),I3_loc,interp);
end
refine(elem,1) = 3;
...
for ie = 1:nelem4
    ie_prev = elem(ie);
    temp = [meshdata(j).elements([1 3 2],index+ie); meshdata(j).elements([1 3 2],index+ie+nelem4)];
    interp = addblocktosparse(temp,meshdata(j-1).elements([1 3 2],ie_prev),I4_loc,interp);
end
refine(elem,1) = 4;
